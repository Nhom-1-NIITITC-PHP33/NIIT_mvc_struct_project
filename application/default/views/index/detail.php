                ...
                navigation: {
                    ...
                    <div class="col-md-7 container-fluid" id="right_product">
                        ...
                        <div class="quantity">
                            ...
                            <span> <input class="input_297o" type="number" value="1">
                            </span>
                        </div><br>
        ...
        <div class="container">
            ...
            <div class="container-fluid">
                        <div  class = " swiper-container " style="width: 100%;height: 300px;">
                            <div  class = " swiper-wrapper " >
                                <div  class = " swiper-slide " >
                                    <img class = 'cloudzoom-gallery' src = "image/iphone-6_1.jpg" >
                                </div>
                                <div  class = " swiper-slide " >
                                    <img class = 'cloudzoom-gallery' src = "image/iphone-7_1.jpg" >
                                </div>
                                <div  class = " swiper-slide " >
                                    <img class = 'cloudzoom-gallery' src = "image/iphone-8-plus_1.jpg" >
                                </div>
